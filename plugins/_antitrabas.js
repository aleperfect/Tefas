/**
𝐓𝐞𝐟𝐚 𝐁𝐨𝐭@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '51992621601-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐓𝐞𝐟𝐚 𝐁𝐨𝐭', 'jpegThumbnail': null } } };
